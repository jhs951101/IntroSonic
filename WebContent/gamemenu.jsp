                ...
                <table border="0" width="170" height="30">
                    <tr>
                        <td width="164" background="images/titlebar.png" height="26">
                            <p align="center"><b><font face="휴먼엽서체" color="white">게임소개</font></b></p>
                        </td>
                    </tr>
                </table>
            </div>
...
<table border="0" width="666" height="41" align="center">
    <tr>
        <td width="660" height="37" valign="bottom">
            <p align="left"><a href="#" OnMouseOut="na_restore_img_src('game_b1', 'document')" OnMouseOver="na_change_img_src('game_b1', 'document', 'images/game-ob1.gif', true);" target="ifrm1"><img border="0" src="images/game-b1.gif" width="83" height="35" name="game_b1"></a>&nbsp;&nbsp;&nbsp;<FONT color=blue face=돋움><a href="#" OnMouseOut="na_restore_img_src('game_b3', 'document')" OnMouseOver="na_change_img_src('game_b3', 'document', 'images/game-ob3.gif', true);" target="ifrm1"><img border="0" src="images/game-b3.gif" width="83" height="35" name="game_b3"></a>&nbsp; &nbsp;</FONT><a href="<%=request.getContextPath()%>/ObjectLoadController?model=game&type=all&page=1" OnMouseOut="na_restore_img_src('game_b2', 'document')" OnMouseOver="na_change_img_src('game_b2', 'document', 'images/game-ob2.gif', true);" target="ifrm1"><img border="0" src="images/game-b2.gif" width="79" height="35" name="game_b2"></a><FONT color=blue face=돋움> &nbsp;※ 왼쪽의 버튼을 클릭하세요!</FONT></p>
        </td>
    </tr>
</table>
